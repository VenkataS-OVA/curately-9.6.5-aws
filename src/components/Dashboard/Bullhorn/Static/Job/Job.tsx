...
const JobStatic = ({ reRoute }: { reRoute: boolean }) => {
    ...
    useEffect(() => {
        if (reRoute) {
            navigate({
                pathname: `/${userLocalData.getvalue('clientName')}/static/job`,
    ...
    // EntityID=174
    // currentBullhornUrl=https%3A%2F%2Fapp.bullhornstaffing.com%2Fcontent%2Frecord%2FJobOrder%2F174%2Fcustom%3Bname%3DCurately%3Burl%3Dhttps%25253A%25252F%25252Fapp.curately.ai%25252F%25253FEntityType%25253DJob%252520Posting%252526UserID%25253D5%252526CorporationID%25253D27170%252526PrivateLabelID%25253D50377
    return reRoute ?
        <></> :
