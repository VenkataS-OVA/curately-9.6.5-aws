...
import { AdapterLuxon, DatePicker } from '../../../../../shared/modules/MaterialImports/DatePicker';
...
const ShowMoreFilters = (
    { communityFormik, hiringStatusList, candidateStatusList, candidateActivityType, sourcesList }
        :
        {
            communityFormik: any;
    ...
    return <>
            ...
            <Accordion className='jobApplication ' expanded={openAccordion === 'panel3'} onChange={handleAccordionMoreFiltersChanges('panel3')}>
                ...
                <AccordionDetails>
                    <TextField
                        ...
                        size="small"
                        select
                        name={`Availability Status Update`}
        ...
        {
            ((communityFormik.values.email.emailClicked !== "") || userLocalData.isChromeExtensionEnabled()) &&
        ...
        {
            ((communityFormik.values.email.emailReplied !== "") || userLocalData.isChromeExtensionEnabled()) &&
        ...
        {
            ((communityFormik.values.email.emailBounced !== "") || userLocalData.isChromeExtensionEnabled()) &&
        ...
        {
            ((communityFormik.values.email.emailSpamBlocked !== "") || userLocalData.isChromeExtensionEnabled()) &&
        ...
        {
            ((communityFormik.values.email.emailUnsubscribed !== "") || userLocalData.isChromeExtensionEnabled()) &&
