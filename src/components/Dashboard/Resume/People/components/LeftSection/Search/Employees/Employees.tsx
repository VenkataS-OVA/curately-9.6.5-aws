...
const Employees: React.FC = () => {
  ...
  const [min, setMin] = useState<any>(searchData.min);
  const [max, setMax] = useState<any>(searchData.max);
  ...
  if (searchData.no_of_employees.includes("1-10")) {
    firstRow = false;
  } else {
    firstRow = true;
  }

  if (searchData.no_of_employees.includes("11-50")) {
    secondRow = false;
  } else {
    secondRow = true;
  }

  if (searchData.no_of_employees.includes("51-200")) {
    thirdRow = false;
  } else {
    thirdRow = true;
  }
  if (searchData.no_of_employees.includes("201-500")) {
    fourthRow = false;
  } else {
    fourthRow = true;
  }

  if (searchData.no_of_employees.includes("501-1000")) {
    fifthRow = false;
  } else {
    fifthRow = true;
  }

  if (searchData.no_of_employees.includes("1001-5000")) {
    sixthRow = false;
  } else {
    sixthRow = true;
  }

  if (searchData.no_of_employees.includes("5001-10000")) {
    seventhRow = false;
  } else {
    seventhRow = true;
  }

  if (searchData.no_of_employees.includes("10001+")) {
    eighthRow = false;
  } else {
    eighthRow = true;
  }

  // if (searchData.no_of_employees.includes("2001-5000")) {
  //   ninthRow = false;
  // } else {
  //   ninthRow = true;
  // }
  ...
  // if (searchData.isClickclearfiltersEmpOpen) {
  //   console.log("test-01", searchData.no_of_employees);
  ...
  // // Set searchData in localStorage when it changes
  // useEffect(() => {
  //   localStorage.setItem("searchData", JSON.stringify(searchData));
  // }, [searchData]);

  // // Get searchData from localStorage on component mount
  // useEffect(() => {
  ...
  //     // Set searchData retrieved from localStorage
  //     setSearchData(searchDataFromLocalStorage);
  //   }
  // }, []);

  React.useEffect(() => {
    // getSearchData("");
    if (searchData.not_exist_fields.includes("employees")) {
      setIsPredefined(false);
      setIsCustom(false);
      setIsEmployeeUnknown(true);
    }
  ...
  const handleChangeMin = (e: any) => {
    const minValue =
      searchData.max === ""
        ...
        : e.target.value.toString() + "-" + searchData.max.toString();
    ...
    if (stringValue.length === 0 || searchData.max.length === 0) {
      setSearchData((prevSearchData: any) => ({
        ...prevSearchData,
        isMinValidation: false,
        isMaxValidation: false,
  ...
  const handleChangeMax = (e: any) => {
    const maxValue =
      searchData.min === ""
        ? "-" + e.target.value.toString()
        : searchData.min.toString() + "-" + e.target.value.toString();

    const stringValue = `${e.target.value}`;
    console.log("string val", stringValue);
    if (stringValue.length <= 6) {
      setMax(e.target.value);
      const currMin = searchData.min;
      if (currMin) {
    ...
    if (stringValue.length === 0 || searchData.min.length === 0) {
      setSearchData((prevSearchData: any) => ({
        ...prevSearchData,
        isMinValidation: false,
        isMaxValidation: false,
                      ...
                      control={
                        <BpCheckboxContainer>
                          <Checkbox
                            ...
                            color="default"
                            checked={
                              searchData.no_of_employees.includes("1-10")
                                ? true
                                : false
                            }
                            checkedIcon={
                      ...
                      control={
                        <BpCheckboxContainer>
                          <Checkbox
                            ...
                            color="default"
                            checked={
                              searchData.no_of_employees.includes("11-50")
                                ? true
                                : false
                            }
                            checkedIcon={
                      ...
                      control={
                        <BpCheckboxContainer>
                          <Checkbox
                            ...
                            color="default"
                            checked={
                              searchData.no_of_employees.includes("51-200")
                                ? true
                                : false
                            }
                            checkedIcon={
                      ...
                      control={
                        <BpCheckboxContainer>
                          <Checkbox
                            ...
                            color="default"
                            checked={
                              searchData.no_of_employees.includes("201-500")
                                ? true
                                : false
                            }
                            checkedIcon={
                      ...
                      control={
                        <BpCheckboxContainer>
                          <Checkbox
                            ...
                            color="default"
                            checked={
                              searchData.no_of_employees.includes("501-1000")
                                ? true
                                : false
                            }
                            checkedIcon={
                      ...
                      control={
                        <BpCheckboxContainer>
                          <Checkbox
                            ...
                            color="default"
                            checked={
                              searchData.no_of_employees.includes("1001-5000")
                                ? true
                                : false
                            }
                            checkedIcon={
                      ...
                      control={
                        <BpCheckboxContainer>
                          <Checkbox
                            ...
                            color="default"
                            checked={
                              searchData.no_of_employees.includes("5001-10000")
                                ? true
                                : false
                            }
                            checkedIcon={
                      ...
                      control={
                        <BpCheckboxContainer>
                          <Checkbox
                            ...
                            color="default"
                            checked={
                              searchData.no_of_employees.includes("10001+")
                                ? true
                                : false
                            }
                            checkedIcon={
                      ...
                      control={
                        <BpCheckboxContainer>
                          <Checkbox
                            ...
                            color="default"
                            checked={
                              searchData.no_of_employees.includes("2001-5000")
                                ? true
                                : false
                            }
