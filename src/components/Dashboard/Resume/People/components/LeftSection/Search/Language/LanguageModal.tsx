...
const LanguageModal = () => {
  ...
  const defLanguagesData = searchModalData.languagesIn.map((name: any) => {
  ...
  const handleChangeLanguages = (event: any, value: any) => {
    ...
    if (value.length > 0) {
      ...
      const updatedLanguagesTitles = searchModalData.languagesIn
  ...
  //   searchModalData.languagesIn.splice(index, 1);

  //   setSearchModalData((prevSearchData: any) => ({
  //     ...prevSearchData,
  //     languagesIn: searchModalData.languagesIn,
  //   }));
  // };

  React.useEffect(() => {
    if (searchModalData.languagesIn.length === 0) {
      setDefLanguages([]);
    }
  }, [searchModalData.languagesIn]);
