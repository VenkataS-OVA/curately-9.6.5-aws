        ...
        {searchModalData.company_names.length ? (
          <>
            ...
            >
              ...
              {searchModalData.company_names.map((company: any, index: any) => (
                <Stack
                  key={index}
                  sx={{
                    display: "flex",
        ...
        {searchModalData.company_not_in_names.length ? (
          <>
            ...
            >
              ...
              {searchModalData.company_not_in_names.map(
        ...
        {searchModalData.company_past_names.length ? (
          <>
            ...
            >
              ...
              {searchModalData.company_past_names.map(
        ...
        {searchModalData.exclude_company_names.length ? (
          <>
            ...
            >
              ...
              {searchModalData.exclude_company_names.map(
...
export default CompanyModalClose;
