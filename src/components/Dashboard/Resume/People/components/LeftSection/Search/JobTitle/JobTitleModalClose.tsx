...
// const JobTitleModalClose: React.FC<Props> = ({ dataJT }) => {
const JobTitleModalClose = () => {
  ...
  //   if (index !== -1) {
  //     const updatedDepartmentElement = searchModalData.title_department_sub_role;
      ...
      >
        ...
        >
          ...
          <Stack sx={{ display: "flex", flexDirection: "row", gap: "3px" }}>
            ...
            0 + searchModalData.title_is_boolean.length ? (
              <></>
            ) : (
              <>
                <Stack
                  ...
                  >
                    ...
                    >
                      {searchModalData.person_titles.length +
                        ...
                        searchModalData.title_is_boolean.length
                          ? 1
                          : 0)}
                    </Typography>
                  </Stack>
        ...
        {searchModalData.person_titles.length ? (
          <>
            ...
            >
              ...
              {searchModalData.person_titles.map((title: any, index: any) => (
                <Stack
                  key={index}
                  sx={{
                    display: "flex",
        ...
        {searchModalData.person_not_titles.length ? (
          <>
            ...
            >
              ...
              {searchModalData.person_not_titles.map((title: any, index: any) => (
                <Stack
                  key={index}
                  sx={{
                    display: "flex",
        ...
        {searchModalData.person_past_titles.length ? (
          <>
            ...
            >
              ...
              {searchModalData.person_past_titles.map((title: any, index: any) => (
                <Stack
                  key={index}
                  sx={{
                    display: "flex",
        ...
        {searchModalData.title_management_level.length ? (
          <>
            ...
            >
              ...
              {searchModalData.title_management_level.map(
                (level: any, index: any) => (
                  <Stack
                    key={index}
                    sx={{
...
export default JobTitleModalClose;
