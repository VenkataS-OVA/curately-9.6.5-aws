...
const Skills = () => {
  ...
  const defSkillsData = searchData.skillsIn.map((name: any) => {
  ...
  const handleChangeSkills = (event: any, value: any) => {
    ...
    if (value.length > 0) {
      ...
      const updatedSkillsTitles = searchData.skillsIn
  ...
  //   searchData.skillsIn.splice(index, 1);

  //   setSearchData((prevSearchData: any) => ({
  //     ...prevSearchData,
  //     skillsIn: searchData.skillsIn,
  //   }));
  // };

  //console.log('skillssss', searchData.skillsIn)

  React.useEffect(() => {
    console.log("work 1");
    if (searchData.skillsIn.length === 0) {
      console.log("work 2");
      setDefSkills([]);
    }
  }, [searchData.skillsIn]);
