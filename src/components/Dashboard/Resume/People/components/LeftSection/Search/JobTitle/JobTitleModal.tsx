...
const JobTitleModal= () => {
  ...
  const [isAnyOf, setIsAnyOf] = useState(
    searchModalData.title_is_boolean ? false : true
  );
  ...
  const [isBooleanSearch, setIsBooleanSearch] = useState(
    searchModalData.title_is_boolean ? true : false
  );
  ...
  const [isNotAnyOf, setIsNotAnyOf] = useState(
    searchModalData.person_not_titles.length ? true : false
  );
  ...
  const [isPastJobTitle, setIsPastJobTitle] = useState(
    searchModalData.person_past_titles.length ? true : false
  );
  ...
  // console.log(searchModalData.person_titles);
  const defData = searchModalData.person_titles.map((name: any) => {
    return { name: name, count: 999 };
  });
  const [defJobTitle, setDefJobTitle] = useState(defData);
  // console.log(defJobTitle, "defJobTitle", searchModalData);
  // console.log("person_titles_len", searchModalData.person_titles.length);

  // if (searchModalData.remove_all_filters_JTO === true) {
  //   setDefJobTitle([]);
  // }
  ...
  const defNotData = searchModalData.person_not_titles.map((name: any) => {
    return { name: name, count: 999 };
  });
  const [defNotTitle, setDefNotTitle] = useState(defNotData);

  const defPastData = searchModalData.person_past_titles.map((name: any) => {
    return { name: name, count: 999 };
  });
  ...
  // setDefJobTitle
  // debugger
  // setDefJobTitle(searchModalData.person_titles.map((option: any) => option.name));
  // console.log(searchModalData.person_titles);

  // const newDataJT: string[] = searchModalData.person_titles;
  ...
  //     person_titles:  ['kkk']
  // })
  // searchModalData.person_titles = [...searchModalData.person_titles, 'some'];
  ...
  //   alert(123);
  // searchModalData.person_titles.push(str);
  // };

  // setSearchModalData(10);
  ...
  const onClickManagementLevelRow = (index: any) => {
    ...
    if (
      searchModalData.title_management_level.includes(clikedManagementRow[0].key)
    ) {
      // const index_clicked_row = searchModalData.title_management_level.indexOf(
      //   clikedManagementRow[0].key
      // );
      // const removedItem = searchModalData.title_management_level.splice(
      //   index_clicked_row,
      //   1
      // );
      const updatedManagementLevel = searchModalData.title_management_level;
      setSearchModalData((prevSearchData: any) => ({
        ...prevSearchData,
  ...
  const handleFilterChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    // console.log("searchModalData.title_department", searchModalData.title_department);
    // console.log(
  ...
  //   if (searchModalData.title_department.includes(checked_parent[0].key)) {
  //     const index_checked_parent = searchModalData.title_department.indexOf(
  //       checked_parent[0].key
  //     );
  //     const removed_uncheck_parent = searchModalData.title_department.splice(
  //       index_checked_parent,
  //       1
  //     );
  //     console.log("removed_uncheck_parent", removed_uncheck_parent);
  //     const updatedParentArray = searchModalData.title_department;
  ...
  //       searchModalData.title_department_sub_role.filter(
  ...
  //       (item: any) => !searchModalData.title_department_sub_role.includes(item.key)
  //     );
  ...
  //   if (searchModalData.title_department_sub_role.includes(clicked_child[0].key)) {
  //     // count_sub_roles = count_sub_roles - 1;
  //     // console.log("count_sub_roles", count_sub_roles);
  //     const index_checked_child = searchModalData.title_department_sub_role.indexOf(
  //       clicked_child[0].key
  //     );
  //     const removed_clicked_child = searchModalData.title_department_sub_role.splice(
  //       index_checked_child,
  //       1
  //     );
  //     // console.log("removed_clicked_child", removed_clicked_child);
  //     let updatedRespectiveParentArray: any[] = searchModalData.title_department;

  //     if (
  //       searchModalData.title_department.includes(checked_respective_parent[0].key)
  //     ) {
  //       const index_clicked_parent = searchModalData.title_department.indexOf(
  //         checked_respective_parent[0].key
  //       );
  //       // console.log("checked_respective_parent", checked_respective_parent);
  //       const removed_parent = searchModalData.title_department.splice(
  //         index_clicked_parent,
  //         1
  //       );
  //       updatedRespectiveParentArray = searchModalData.title_department;
  //     }

  //     const updatedRespectiveChildArray = searchModalData.title_department_sub_role;
  ...
  //     //   searchModalData.title_department_sub_role.splice(index_checked_child, 1);
  //     // console.log("children", checked_respective_parent_children);
  //     // console.log("clicked_child", clicked_child);
  //     let updatedRespParentArray = searchModalData.title_department;
  //     console.log("children_length", children_length);
  ...
  const handleParentCheckboxChange = (event: any, parentId: any) => {
    ...
    if (searchModalData.title_department.includes(checked_parent[0].key)) {
      ...
      searchModalData.title_department.splice(index_checked_parent, 1);
      ...
      searchModalData.title_department.push(checked_parent[0].key);

      checked_parent[0].children.forEach((child: any) => {
        if (!searchModalData.title_department_sub_role.includes(child.key)) {
          // console.log("child.key", child.key);
          searchModalData.title_department_sub_role.push(child.key);
        }
      });
    }
    ...
    setSearchModalData((prevSearchData: any) => ({
      ...prevSearchData,
      title_department: [...searchModalData.title_department],
      title_department_sub_role: [...searchModalData.title_department_sub_role],
    }));
  };
  ...
  const handleChildCheckboxChange = (
    ...
    if (searchModalData.title_department_sub_role.includes(clicked_child.key)) {
      const index_checked_child = searchModalData.title_department_sub_role.indexOf(
        clicked_child.key
      );
      searchModalData.title_department_sub_role.splice(index_checked_child, 1);
      ...
      const allChildrenChecked = checked_respective_parent_children.every(
        (child: any) => searchModalData.title_department_sub_role.includes(child.key)
      );
      ...
      if (!allChildrenChecked) {
        ...
        if (index_clicked_parent !== -1) {
          searchModalData.title_department.splice(index_clicked_parent, 1);
        }
      }
    } else {
      searchModalData.title_department_sub_role.push(clicked_child.key);
      ...
      if (
        ...
        searchModalData.title_department.push(checked_respective_parent[0].key);
      }
    }
  ...
  const removeDepartmentParentElement = (index: any) => {
    if (index !== -1) {
      const updatedDepartmentParentTitles = searchModalData.title_department;
  ...
  const removeDepartmentElement = (index: any) => {
    if (index !== -1) {
      const updatedDepartmentTitles = searchModalData.title_department_sub_role;
  ...
  React.useEffect(() => {
    if (searchModalData.person_titles === "") {
      setDefJobTitle("");
    }
    if (searchModalData.person_not_titles === "") {
      setDefNotTitle("");
    }
    if (searchModalData.person_past_titles === "") {
      setDefPastTitle("");
    }
  }, [
    searchModalData.person_titles,
    searchModalData.person_not_titles,
    searchModalData.person_past_titles,
  ]);

  useEffect(() => {
    if (searchModalData.title_is_boolean === "") {
      setbooleanValue("");
    }
  }, [searchModalData.title_is_boolean]);
  ...
  React.useEffect(() => {
    // getSearchData("");
    // console.log("searchModalData useEffect", searchModalData);
    if (searchModalData.exist_fields.includes("job_title")) {
      setIsUnKnown(false);
      setIsAnyOf(false);
      setIsBooleanSearch(false);
      setIsKnown(true);
      setIsNotAnyOf(false);
      setIsPastJobTitle(false);
    } else if (searchModalData.not_exist_fields.includes("job_title")) {
      setIsUnKnown(true);
      setIsAnyOf(false);
      setIsBooleanSearch(false);
      setIsKnown(false);
              ...
              {isAnyOf && (
                <Stack spacing={1}>
                  ...
                  <Autocomplete
                    ...
                    // value={
                    //   searchModalData.person_titles.length === 0 ? [] : defJobTitle
                    // }
                    renderInput={(params) => (
                      <TextField
                        sx={{
            ...
            >
              {
                            ...
                            control={
                              <BpCheckboxContainer>
                                <Checkbox
                                  ...
                                  color="default"
                                  checked={
                                    searchModalData.title_management_level.includes(
                                      item.key
                                    )
                                      ? true
                                      : false
                ...
                >
                  ...
                  // <Stack>
                  (searchModalData.title_management_level.map((level: any, index: any) => (
                    <Stack
                      key={index}
                      sx={{
                        display: "flex",
          ...
          >
            ...
            {isDepartment ? (
                          ...
                          >
                            <BpCheckboxContainer>
                              <Checkbox
                                disableRipple
                                checked={
                                  searchModalData.title_department.includes(
                                    parent.key
                                  )
                                    ? true
                                    : false
                                ...
                                indeterminate={
                                  ...
                                  checkboxData
                                    ...
                                    .children.map((item: any) =>
                                      searchModalData.title_department_sub_role.includes(
                                        item.key
                                      )
                                    )
              ...
              >
                ...
                <>
                  {searchModalData.title_department.map((label: any, index: any) => (
                    <Stack
                      key={index}
                      sx={{
                        display: "flex",
                ...
                {/* ) : ( */}
                <>
                  {searchModalData.title_department_sub_role.map(
                    (label: any, index: any) =>
