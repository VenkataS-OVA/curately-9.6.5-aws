...
// const ProfileResearch: React.FC<ResearchProps> = ({ companydetails, keywords, mobile }) => {
                                ...
                                <Box sx={{ display: 'flex', flexDirection: 'row', width: 'auto', gap: 1, flexWrap: 'wrap' }}>
                                    <Box>
                                        <Box sx={{
                                            ...
                                            <Typography component='p' sx={{ color: '#474747', fontFamily: 'system-ui, -apple-system, "Segoe UI", Roboto, Ubuntu, Cantarell, "Noto Sans", sans-serif, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"', fontWeight: 600, fontSize: '12px' }}>telecommunication</Typography>
                                        </Box>
                                    </Box>
                        ...
                        <Box sx={{
                            ...
                            <Box>
                                <Typography sx={{ color: isTech ? '#146EF6' : '#474747', fontFamily: 'system-ui, -apple-system, "Segoe UI", Roboto, Ubuntu, Cantarell, "Noto Sans", sans-serif, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"', fontSize: '14px', fontWeight: 600 }}>
                                    Technologies  <Box component='span' sx={{ pl: 5 }}>21</Box>
                                </Typography>
                            </Box>
                        </Box>
